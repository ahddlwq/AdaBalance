...
class AdaBalance(Optimizer):
    """Implements AdaBalance algorithm.
    It has been proposed in `AdaBalance: Novel Adaptive Gradient Optimization via Recalculation and Constrained Learning Rates`_.
    Arguments:
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), beta3=0.999, final_lr=0.1, gamma=1e-3,
        ...
        super(AdaBalance, self).__init__(params, defaults)

        self.base_lrs = list(map(lambda group: group['lr'], self.param_groups))

    def __setstate__(self, state):
        super(AdaBalance, self).__setstate__(state)
