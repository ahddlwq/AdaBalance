...
parser.add_argument('--beta3', default=0.999, type=float,
                    help='AdaMod or AdaBalance coefficients beta_3')
...
try:
    ...
    if args.optimizer == 'adamod':
        optimizer = AdaMod(params, lr=args.lr, betas=(args.beta1, args.beta2), beta3=args.beta3,
                           weight_decay=args.wdecay)
    if args.optimizer == 'adabalance':
        # optimizer = AdaBalance(params, lr=args.lr, betas=(args.beta1, args.beta2), beta3=args.beta3,
        #      weight_decay=args.wdecay)
        optimizer = AdaBalance(params, lr=args.lr, betas=(args.beta1, args.beta2), beta3=args.beta3,
                              weight_decay=args.wdecay, final_lr=30, gamma=1e-3)
