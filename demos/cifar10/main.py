...
from adabalance import AdaBalance
...
def get_parser():
    ...
    parser.add_argument('--optim', default='sgd', type=str, help='optimizer',
                        choices=['sgd', 'adagrad', 'adam', 'amsgrad', 'adabound', 'amsbound', 'adabalance'])
    ...
    parser.add_argument('--beta3', default=0.999, type=float, help='AdaBalance coefficients beta_3')
...
def get_ckpt_name(model='resnet', optimizer='sgd', lr=0.1, final_lr=0.1, momentum=0.9,
                  beta1=0.9, beta2=0.999, beta3=0.999, gamma=1e-3):
    name = {
        ...
        'adabalance': 'lr{}-betas{}-{}-{}-final_lr{}-gamma{}'.format(lr, beta1, beta2, beta3, final_lr, gamma),
    }[optimizer]
...
def create_optimizer(args, model_params):
    if args.optim == 'sgd':
        ...
        return AdaBound(model_params, args.lr, betas=(args.beta1, args.beta2),
                        ...
                        weight_decay=args.weight_decay)
    elif args.optim == 'adabalance':
        return AdaBalance(model_params, args.lr, betas=(args.beta1, args.beta2),
                         beta3=args.beta3, final_lr=args.final_lr, gamma=args.gamma,
                         weight_decay=args.weight_decay)
    else:
...
def main():
    ...
    ckpt_name = get_ckpt_name(model=args.model, optimizer=args.optim, lr=args.lr,
                              ...
                              beta1=args.beta1, beta2=args.beta2, beta3=args.beta3, gamma=args.gamma)
    if args.resume:
